...
export const experience = [
  ...
  },
  {
    ...
    period: "2017 — 2019",
    bullets: [
      "Начинал как QA Engineer: занимался функциональным тестированием, тестовыми сценариями, заведением дефектов и проверкой требований.",
      "Позже перешёл в frontend-разработку и участвовал в развитии клиентских приложений компании.",
      "Работал с legacy-кодом, помогал переводить части проекта на React и упрощать поддержку интерфейсов.",
      "Участвовал в рефакторинге, аудите зависимостей и улучшении архитектуры запросов к API.",
